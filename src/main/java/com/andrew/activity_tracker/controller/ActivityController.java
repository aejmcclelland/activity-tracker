...
public class ActivityController {
    ...
    public ResponseEntity<ActivityResponse> createActivity(@Valid @RequestBody ActivityRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(ActivityResponse.from(savedActivity));
    }
    ...
    public ResponseEntity<ActivityResponse> updateActivity(@PathVariable Long id, @Valid @RequestBody ActivityRequest request) {
        ...
        updatedActivity.setActivityType(request.getActivityType());
        updatedActivity.setActivityDate(request.getActivityDate());
        updatedActivity.setDurationMinutes(request.getDurationMinutes());
        updatedActivity.setDistanceMiles(request.getDistanceMiles());
        updatedActivity.setNotes(request.getNotes());
